...
/// @return
error initial_approximation_builder::simple_pressure_initial_approximation(const thread_info &thr_info)
{
...
error initial_approximation_builder::construct_pressure_initial_approximation(bool is_simple_ia, const thread_info &thr_info)
{
    if (is_simple_ia)
        return simple_pressure_initial_approximation(thr_info);
