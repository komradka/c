...
#include "nd/gui/main_window.hpp"
...
#include "nd/gui/manager_gui/create_project_dialog.hpp"
...
public:
    ...
    Q_SLOT void copy_results (const std::map<object_id, phys_q> &object_res)
    {
...
//        }
    ...
    Q_SLOT void make_pipe_project()
    {
        window->make_pipe_project();
    }

    Q_SLOT void make_network()
    {
        if (network_topology != nullptr)
        {
...
//            rep->print_message("Network successfully created");
    ...
    Q_SLOT void crete_project_click()
    {
